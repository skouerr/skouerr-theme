...
function wp_sk_scripts_widget()
{
    ...
    $port = apply_filters('skouerr_scripts_port', 4000);
    ...
    $settings['display'] = apply_filters('skouerr_scripts_widget_display', true);

    $widget_data['settings'] = apply_filters('skouerr_scripts_widget_settings', $settings);
    ...
    $widget_data['server_infos'] = apply_filters('skouerr_scripts_widget_server_infos', $server_infos);
    ...
    $widget_data['page_infos'] = apply_filters('skouerr_scripts_widget_page_infos', $page_infos);

    $wp_sk_scripts_widget_active = wp_get_environment_type() === 'development';
    $wp_sk_scripts_widget_active = apply_filters('skouerr_scripts_widget_active', $wp_sk_scripts_widget_active);
...
add_filter('skouerr_scripts_port', function () {
    return 4100;
});
