 ...
 */
?>
<!-- wp:group {"metadata":{"patternName":"skouerr/hero-home","name":"Hero home"},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":1} -->
	<h1 class="wp-block-heading has-text-align-center">Skouerr Dev Env</h1>
	<!-- /wp:heading -->
...
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","layout":{"type":"constrained","justifyContent":"center"}} -->
...
<!-- wp:spacer {"height":"var:preset|spacing|3-xl"} -->
<div style="height:var(--wp--preset--spacing--3-xl)" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->

<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
	<div class="wp-block-column"><!-- wp:image {"width":"564px","height":"auto","aspectRatio":"4/3","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
		<figure class="wp-block-image size-large is-resized"><img src="https://images.pexels.com/photos/13622614/pexels-photo-13622614.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1260&amp;h=750&amp;dpr=2" alt="" style="aspect-ratio:4/3;object-fit:cover;width:564px;height:auto" /></figure>
		<!-- /wp:image -->
	</div>
	<!-- /wp:column -->
